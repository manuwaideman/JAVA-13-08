    ...
    public static void main(String[] args) {
        ...
        do {
            try {
                String sigla, estado;
                do {
                    sigla = JOptionPane.showInputDialog("Digite a UF de um estado ou digite \"FIM\"").toUpperCase();
                    if (!sigla.equals("FIM")){
                        estado = JOptionPane.showInputDialog("Digite o nome complesto do estado informado anteriormente");
